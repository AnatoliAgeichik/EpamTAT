...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Military entity.airport sorted by max distance: " + militaryAirport
                .sortByMaxDistance()
                .toString());
        System.out.println("Passenger entity.airport sorted by max speed: " + passengerAirport
                .sortByMaxSpeed()
                .toString());
